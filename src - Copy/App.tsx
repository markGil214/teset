...
// Wrapper component to force remounting of ARScannerPage when organ changes
const ARScannerPageWrapper: React.FC = () => {
  const [searchParams] = useSearchParams();
  const organId = searchParams.get("organ");
  
  // Use the organ ID as key to force component remounting when organ changes
  // This ensures complete state reset when switching between different organs
  return <ARScannerPage key={organId || 'default'} />;
};
